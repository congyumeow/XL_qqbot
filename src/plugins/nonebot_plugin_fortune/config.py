...
class ThemesFlagConfig(BaseModel, extra=Extra.ignore):
    ...
    amazing_grace_flag: bool = True   # 奇异恩典·圣夜的小镇
    arknights_flag: bool = True   # 明日方舟
    asoul_flag: bool = True   # A-SOUL
    azure_flag: bool = True   # 碧蓝航线
    dc4_flag: bool = True   # dc4
    einstein_flag: bool = True   # 爱因斯坦携爱敬上
    genshin_flag: bool = True   # 原神
    granblue_fantasy_flag: bool = True   # 碧蓝幻想
    hololive_flag: bool = True   # Hololive
    hoshizora_flag: bool = True   # 星空列车与白的旅行
    liqingge_flag: bool = True   # 李清歌
    onmyoji_flag: bool = True   # 阴阳师
    pcr_flag: bool = True   # 公主连结
    pretty_derby_flag: bool = True   # 赛马娘
    punishing_flag: bool = True   # 战双帕弥什
    sakura_flag: bool = True   # 樱色之云绯色之恋
    summer_pockets_flag: bool = True   # 夏日口袋
    sweet_illusion_flag: bool = True   # 灵感满溢的甜蜜创想
    touhou_flag: bool = True   # 东方
    touhou_lostword_flag: bool = True   # 东方归言录
    touhou_old_flag: bool = True   # 东方旧版
    warship_girls_r_flag: bool = True   # 战舰少女R
